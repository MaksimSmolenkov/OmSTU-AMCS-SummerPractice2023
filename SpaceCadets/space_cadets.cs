...
public class Program
{
    public static void Main(string[] way)
    {
        ...
        List<Cadets> students = json_file.data.ToObject<List<Cadets>>();
    ...
    public static List<dynamic> GetStudentsWithHighestGPA(List<Cadets> students)
    {
    ...
    public static List<dynamic> CalculateGPAByDiscipline(List<Cadets> students)
    {
    ...
    public static List<dynamic> GetBestGroupsByDiscipline(List<Cadets> students)
    {
